...
alter table amele_student add constraint amele_student_pk primary key (ssn);
alter table amele_student_class add constraint amele_stu_cla_pk primary key(ssn,class_code);
alter table amele_class add constraint amele_clss_pk primary key(class_code);
alter table amele_student_class add constraint amele_st_fk foreign key (ssn) references amele_student;
alter table amele_student add constraint amele_student_uk unique(lname,fname);
create index amele_clss_desc_indx on amele_class (class_description);

insert into amele_student
...
insert into amele_student_class
